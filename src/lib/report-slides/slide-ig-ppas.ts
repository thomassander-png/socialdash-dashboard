...
function generate(ctx: SlideContext): void {
  ...
  kpis.forEach((kpi, idx) => {
    ...
    slide.addShape('rect', {
      ...
      fill: { color: isAlt ? DESIGN.colors.lightGray : DESIGN.colors.white }
    });
...
export const slideIgPpas: SlideModule = {
  id: 'igPpas',
  name: 'IG PPAs',
  description: 'Instagram Beitragsbewerbungen mit 3-Monats-Vergleich und Kampagnenliste',
  platform: 'instagram',
  category: 'ads',
  order: 34,
  generate,
