...
import { generateFamefactReport, ReportData } from '@/lib/famefact-report-generator';
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (fbPageIds.length > 0) {
      ...
      // Get ALL Facebook posts (images) - NO LIMIT
      ...
      // Get ALL Facebook videos - NO LIMIT
    ...
    if (igAccountIds.length > 0) {
      ...
      // Get ALL Instagram posts (images) - NO LIMIT
      ...
      // Get ALL Instagram reels - NO LIMIT
    ...
    console.error('Famefact report generation error:', error);
