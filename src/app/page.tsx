  ...
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <KPICard title="Gesamt Interaktionen" value={formatNumber(combinedInteractions)} icon="💬" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
          ...
          {fbTopPosts.length === 0 ? (
            ...
            <div className="space-y-4">
              {fbTopPosts.map((post) => (
                <div key={post.post_id} className="border-b border-gray-700 pb-4 last:border-0">
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
          ...
          {igTopPosts.length === 0 ? (
            ...
            <div className="space-y-4">
              {igTopPosts.map((post) => (
                <div key={post.media_id} className="border-b border-gray-700 pb-4 last:border-0">
